    ...
    class TACPP4_Terms_Conditions_Per_Categories {
        ...
        public static function product_terms_custom_fields( $tag ) {
			...
			<tr class="form-field">
                ...
                if ( $term_id ) { ?>
					<th scope="row" valign="top">
						<label for="category_terms_text"><?php _e( 'Terms and Conditions URL', 'terms-and-conditions-per-product' ); ?></label>
					</th>
                <?php } ?>
				<td>
			...
			<tr class="form-field">
                ...
                if ( $term_id ) { ?>
					<th scope="row" valign="top">
						<label for="category_terms_text"><?php _e( 'Terms and Conditions Text', 'terms-and-conditions-per-product' ); ?></label>
					</th>
                <?php } ?>
				<td>
					<div class="product_cat_custom_field">
