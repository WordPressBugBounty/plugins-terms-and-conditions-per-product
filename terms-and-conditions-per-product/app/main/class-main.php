					...
					<div class="extra-terms">
						<p class="form-row terms wc-terms-and-conditions form-row validate-required">
							<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
								<input type="checkbox" class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox" name="terms-<?php echo absint( $product_id ); ?>" <?php checked( apply_filters( 'woocommerce_terms_is_checked_default', isset( $_POST[ 'terms-' . absint( $product_id ) ] ) ), true ); ?> id="terms-<?php echo $product_id; ?>">
